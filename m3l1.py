...
@app.route("/")
def hello():
    return f'<h1>Merhaba bu sayfa bir aracıdır aşağıda bulunan linke tıklayarak rastgele gercekleri öğrenebileceğiniz sayfaya ulaşabilirsiniz</h1>  <a href="/rastgele_gercek">Rastgele bir gerçeği görüntüle!</a>'
